(function($) {
        ...
        buttons: [
            {
                ...
                customize: function(xlsx) {
                    ...
                    $('row c[r^="A1"]', sheet).each( function () {
                        if ( $('is t', this).text() == 'ACAI' ) {
                            $('is t', this).text( 'Listado de proveedores - ACAI'+ dateString );
                        } else {
                            $('is t', this).text( 'Listado de proveedores - ACAI'+ dateString );
                        }
                    });
                ...
                filename: function() {
                    ...
                    return 'Listado de proveedores - ' + day + ' de ' + month + ' de ' + year;
                },
                exportOptions: {
                    modifier: {
                        search: 'applied',
            ...
            },
            {
                ...
                customize: function (doc) {
                    ...
                    doc.content.splice(0, 1, {
                        text: 'Listado de proveedores - ACAI\n'+ dateString,
                        fontSize: 12,
                        alignment: 'center',
                        margin: [0, 0, 0, 12]
                    });
    ...
    $("input").on("keyup change", function() {
        ...
        // Adjust the column index to account for the excluded first column
