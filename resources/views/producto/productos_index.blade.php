...
@can('create_products')
@section('create')
<a class="btn btn-sm btn-success" href="#" data-toggle="modal" data-target="#create_product" style="font-size: clamp(0.6rem, 3.2vw, 0.8rem); border-radius: 5px">
...
@include('producto._productos_create')
