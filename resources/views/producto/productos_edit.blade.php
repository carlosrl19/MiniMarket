    ...
    <div class="card shadow mb-4 ">
        ...
        <div class="card-header py-3" style="background: #4e73df; border-radius:5px 5px 0 0;">
            ...
            <div style="float: left">
                <h2 class="m-0 font-weight-bold" style="color: white; font-size: clamp(0.8rem, 3vw, 1rem);">Editar producto</h2>
            </div>
        </div>
        <br>
        <div class="container">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4 mb-3 mb-sm-0" style="display: none">
                                    <label for="prec_venta_may" class="form-label">Precio de venta (mayorista):</label>
                                    <input type="text"
                                           class="form-control @error('prec_venta_may') is-invalid @enderror"
                                           id="prec_venta_may"
                                           name="prec_venta_may"
                                           value="{{old('prec_venta_may', $producto->prec_venta_may)}}" 
                                ...
                                <div class="col-sm-4 mb-3 mb-sm-0">
                                    <label for="prec_venta_fin" class="form-label">Precio de venta:</label>
                                    <input type="text"
                                           class="form-control @error('prec_venta_fin') is-invalid @enderror"
                                           id="prec_venta_fin"
                                           name="prec_venta_fin"
                                           value="{{old('prec_venta_fin', $producto->prec_venta_fin)}}" 
                                           autocomplete="off"
                                ...
                                <div class="col-sm-4 mb-3 mb-sm-0">
                                    ...
                                    <select class="form-control @error('id_categoria') is-invalid @enderror"
                                            id="id_categoria" style="font-size: clamp(0.6rem, 3.2vw, 0.95rem);"
                                ...
                                <div class="col-sm-12 mb-3 mb-sm-0" style="margin-top: 6px">
                                    ...
                                    <textarea class="form-control @error('descripcion') is-invalid @enderror"
                                              ...
                                              rows="5" style="resize: none">@if(old("descripcion")){{old("descripcion")}}@else{{$producto->descripcion}}@endif</textarea>
                                    @error('descripcion')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-sm-6 mb-3 mb-sm-0" style="margin-top: 6px">
                                    ...
                                    <input type="text" class="form-control @error('marca') is-invalid @enderror"
                                           id="marca"
                                           name="marca" value="{{old('marca', $producto->marca)}}" 
                                           autocomplete="off"
                                           autofocus>
                                    @error('marca')
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-sm-6 mb-3 mb-sm-0" style="margin-top: 6px">
                                    ...
                                    <input type="text" class="form-control @error('modelo') is-invalid @enderror"
                                           id="modelo"
                                           name="modelo" value="{{old('modelo', $producto->modelo)}}" 
                                           autocomplete="off"
                                           autofocus>
                                    @error('modelo')
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0" style="margin-top: 6px;">
                                    ...
                                    <input type="text" class="form-control @error('existencia') is-invalid @enderror"
                                           id="existencia" name="existencia" value="{{old('existencia', $producto->existencia)}}"                                           
                                           autocomplete="off" autofocus maxlength="7"
                                           onkeypress="return funcionLempiras(event);">
                                    @error('existencia')
                                    <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-sm-12 mb-3 mb-sm-0" style="margin-top: 6px">
                                    ...
                                    <input type="text" class="form-control @error('codigo') is-invalid @enderror"
                                           ...
                                           minlength="4" maxlength="13" autocomplete="off"
