    ...
    <div class="card shadow mb-4" style="background: whitesmoke">
        <div class="card-header py-3" style="background: #4e73df">
            <div style="float: left">
                <h2 class="m-0 font-weight-bold" style="color: white; font-size: clamp(0.8rem, 3vw, 1rem);">Registrar categoria</h2>
            </div>
        </div>
                    ...
                    <div class="p-5" style="font-family: 'Nunito', sans-serif; font-size: small; padding-top: 10px">
                        <form action="{{ route('categorias.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    ...
                                    <select class="form-control @error('status') is-invalid @enderror"
                                            ...
                                            autofocus>
                                        <option value="" selected disabled>Seleccione el estado de la categoría</option>
                            ...
                            <div class="form-group row mt-2">
                                <div class="col-sm-6">
                                    <a href="/categorias" style="font-size: clamp(0.6rem, 3.2vw, 1rem); display: inline-block; background: #2c3034; color: white; border: 2px solid #ffffff;border-radius: 10px;"
