...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'nombre_proveedor' => 'required|string|min:3|max:55|regex:/^[^\d]+$/|unique:proveedors,nombre_proveedor,'. $proveedorId . '',
    ...
    public function messages()
    {
        return [
            ...
            'rtn_proveedor.regex' => 'El RTN de la proveedora debe contener únicamente números.',
