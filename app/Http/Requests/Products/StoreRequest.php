...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'codigo'=>  'nullable|string|regex:/^[0-9]+$/|min:4|max:13|unique:productos',
            'marca' => 'required|string|min:3|max:40',
            'modelo' => 'required|string|min:3|max:40|unique:productos',
            ...
            'prec_venta_may'=>  'required|numeric|min:'.$prec_compra , 'max:999999999',
            'prec_venta_fin'=>  'required|numeric|min:'.$prec_compra, 'max:999999999',
    ...
    public function messages()
    {
        return [
            ...
            'prec_compra.min' => 'El precio de compra debe ser superior a L. 0.01.',
